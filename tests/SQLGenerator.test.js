...
describe('SQL Generator individual function tests for Budrpt-90', () => {
	...
	it('select() should return a valid select statement', () => {
		expect(generator.select('Income Statement', '13th', 2017)).to.be.equal(`SELECT a.GBCO,b.GMOBJ,b.GMSUB,b.GMLDA,trim(b.GMDL01) as GMDL01,SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 16 THEN a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 as PriorAnnualAct, SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13-a.GBAPYC ELSE 0 END)/100 as PriorYTDAct, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 17 THEN a.GBBORG ELSE 0 END)/100 as CurrentOrigBud, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 17 THEN a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 as CurrentModBud, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 17 THEN a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 - SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 17 THEN a.GBAPYC+a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 - SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 17 THEN a.GBAPYC+a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13-a.GBAPYC ELSE 0 END)/100 as CurrentAvailBal, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 17 THEN a.GBAPYC+a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13-a.GBAPYC ELSE 0 END)/100 as CurrentYTDBud, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 17 THEN a.GBAPYC+a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 as CurrentYTDEnc, SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 17 THEN a.GBAPYC+a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13-a.GBAPYC ELSE 0 END)/100 as CurrentYTDAct, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 17 THEN a.GBAPYC+a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 +SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 17 THEN a.GBAPYC+a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13-a.GBAPYC ELSE 0 END)/100 as CurrentYTDTotal, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 17 THEN a.GBAN13 ELSE 0 END)/100 as CurrentPTDBud, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 17 THEN a.GBAN13 ELSE 0 END)/100 as CurrentPTDEnc, SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 17 THEN a.GBAN13 ELSE 0 END)/100 as CurrentPTDAct, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 17 THEN a.GBAN13 ELSE 0 END)/100 + SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 17 THEN a.GBAN13 ELSE 0 END)/100 as CurrentPTDTotal, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 18 THEN a.GBBORG ELSE 0 END)/100 as ProposedAnnualBud `);
		...
		expect(generator.select('Income Statement', 'Oct', 2017)).to.be.equal(`SELECT a.GBCO,b.GMOBJ,b.GMSUB,b.GMLDA,trim(b.GMDL01) as GMDL01,SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 16 THEN a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 as PriorAnnualAct, SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as PriorYTDAct, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 17 THEN a.GBBORG ELSE 0 END)/100 as CurrentOrigBud, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 17 THEN a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 as CurrentModBud, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 17 THEN a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 - SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 17 THEN a.GBAPYC+a.GBAN01 ELSE 0 END)/100 - SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 17 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as CurrentAvailBal, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 17 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as CurrentYTDBud, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 17 THEN a.GBAPYC+a.GBAN01 ELSE 0 END)/100 as CurrentYTDEnc, SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 17 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as CurrentYTDAct, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 17 THEN a.GBAPYC+a.GBAN01 ELSE 0 END)/100 +SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 17 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as CurrentYTDTotal, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 17 THEN a.GBAN01 ELSE 0 END)/100 as CurrentPTDBud, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 17 THEN a.GBAN01 ELSE 0 END)/100 as CurrentPTDEnc, SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 17 THEN a.GBAN01 ELSE 0 END)/100 as CurrentPTDAct, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 17 THEN a.GBAN01 ELSE 0 END)/100 + SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 17 THEN a.GBAN01 ELSE 0 END)/100 as CurrentPTDTotal, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 18 THEN a.GBBORG ELSE 0 END)/100 as ProposedAnnualBud `)
	...
	it('createSelectStatement() should genearate a valid select statement', () => {
		...
		expect(generator.createSelectStatement(true, 'Income Statement', 2016, 'Oct', 'acc', options)).to.be.equal(`SELECT a.GBCO,b.GMOBJ,b.GMSUB,b.GMLDA,trim(b.GMDL01) as GMDL01,SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 15 THEN a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 as PriorAnnualAct, SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 15 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as PriorYTDAct, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 16 THEN a.GBBORG ELSE 0 END)/100 as CurrentOrigBud, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 16 THEN a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 as CurrentModBud, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 16 THEN a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 - SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01 ELSE 0 END)/100 - SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as CurrentAvailBal, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as CurrentYTDBud, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01 ELSE 0 END)/100 as CurrentYTDEnc, SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as CurrentYTDAct, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01 ELSE 0 END)/100 +SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as CurrentYTDTotal, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 16 THEN a.GBAN01 ELSE 0 END)/100 as CurrentPTDBud, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 16 THEN a.GBAN01 ELSE 0 END)/100 as CurrentPTDEnc, SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 16 THEN a.GBAN01 ELSE 0 END)/100 as CurrentPTDAct, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 16 THEN a.GBAN01 ELSE 0 END)/100 + SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 16 THEN a.GBAN01 ELSE 0 END)/100 as CurrentPTDTotal, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 17 THEN a.GBBORG ELSE 0 END)/100 as ProposedAnnualBud  FROM proddta.F0901 b,proddta.F0902 a  WHERE ( (b.GMAID = a.GBAID(+)) AND ((b.GMOBJ acc)) AND ((b.GMCO in (companyKey) OR b.GMMCU in (BUKey))) AND ((a.GBLT in ('AA','PA','BA') OR a.GBLT IS NULL )) AND ((a.GBFY in (15,16,17) OR a.GBFY IS NULL ))) GROUP BY a.GBCO,b.GMOBJ,b.GMSUB,b.GMLDA,trim(b.GMDL01) ORDER BY b.GMOBJ,b.GMSUB,b.GMLDA`)
...
describe('SQL Generator individual function tests for Budrpt_a-90', () => {
	...
	it('createSelectStatement() should genearate a valid select statement', () => {
		...
		expect(generator.createSelectStatement(true, 'Income Statement', 2016, 'Oct', 'acc', options)).to.be.equal(`SELECT a.GBCO,b.GMOBJ,b.GMSUB,b.GMLDA,trim(b.GMDL01) as GMDL01,SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 15 THEN a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 as PriorAnnualAct, SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 15 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as PriorYTDAct, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 16 THEN a.GBBORG ELSE 0 END)/100 as CurrentOrigBud, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 16 THEN a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 as CurrentModBud, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 16 THEN a.GBAN01+a.GBAN02+a.GBAN03+a.GBAN04+a.GBAN05+a.GBAN06+a.GBAN07+a.GBAN08+a.GBAN09+a.GBAN10+a.GBAN11+a.GBAN12+a.GBAN13 ELSE 0 END)/100 - SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01 ELSE 0 END)/100 - SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as CurrentAvailBal, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as CurrentYTDBud, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01 ELSE 0 END)/100 as CurrentYTDEnc, SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as CurrentYTDAct, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01 ELSE 0 END)/100 +SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 16 THEN a.GBAPYC+a.GBAN01-a.GBAPYC ELSE 0 END)/100 as CurrentYTDTotal, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 16 THEN a.GBAN01 ELSE 0 END)/100 as CurrentPTDBud, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 16 THEN a.GBAN01 ELSE 0 END)/100 as CurrentPTDEnc, SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 16 THEN a.GBAN01 ELSE 0 END)/100 as CurrentPTDAct, SUM(CASE WHEN a.GBLT = 'PA' and a.GBFY = 16 THEN a.GBAN01 ELSE 0 END)/100 + SUM(CASE WHEN a.GBLT = 'AA' and a.GBFY = 16 THEN a.GBAN01 ELSE 0 END)/100 as CurrentPTDTotal, SUM(CASE WHEN a.GBLT = 'BA' and a.GBFY = 17 THEN a.GBBORG ELSE 0 END)/100 as ProposedAnnualBud  FROM proddta.F0901 b,proddta.F0902 a  WHERE ( (b.GMAID = a.GBAID(+)) AND ((b.GMOBJ acc)) AND ((b.GMCO in (companyKey) OR b.GMMCU in (BUKey))) AND ((a.GBLT in ('AA','PA','BA','B3') OR a.GBLT IS NULL )) AND ((a.GBFY in (15,16,17) OR a.GBFY IS NULL ))) GROUP BY a.GBCO,b.GMOBJ,b.GMSUB,b.GMLDA,trim(b.GMDL01) ORDER BY b.GMOBJ,b.GMSUB,b.GMLDA`)
	})
