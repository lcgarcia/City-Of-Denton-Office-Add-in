...
module.exports = {
  ...
  mapSubTotalRows: (groupedRows, headerOffset, isFerc) => _.map(groupedRows, val => {
  ...
  addSubTotalRows: (groupedByKey, columnNames, headerOffset, rowPadding, optionalProjectList, isFerc) => 
  ...
  addManagerSubTotalRows: (groupedByKey, columnNames, headerOffset, rowPadding, isFerc) => 
    _.map(groupedByKey, (val, key) => {
